...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=[20,100], args=None):
        self.inplanes = 64
    ...
    def forward(self, x):
        ...
        #x2 = self.avgpool(x)##
        #x2 = nn.Flatten()(x2) ##
        #level_1 = self.softmax_reg1(self.linear_lvl1(x2)) ##
        #level_2 = self.softmax_reg2(torch.cat((level_1, self.linear_lvl2(x2)), dim=1))##
