...
# Download the checkpoint file from URL
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
        ...
        if 'cifar' or 'cifar10_hi' in args["dataset"]:
        ...
        #self.linear_lvl1 = nn.Linear(self.out_dim, num_classes[0])
        #self.linear_lvl2 = nn.Linear(self.out_dim, num_classes[1])
    ...
    def _forward_impl(self, x):
        ...
        x_5 =  nn.Flatten()(pooled)  # [bs, 512]
        #level_1 = self.softmax_reg1(self.linear_lvl1(x_5))
        #level_2 = self.softmax_reg2(torch.cat((level_1, self.linear_lvl2(x_5)), dim=1))
